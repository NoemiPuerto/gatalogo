    ...
    <AppShell>
      <section className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-20 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-6 max-w-xl text-lg text-slate-600">Gatalogo gives adopters and shelters separate workspaces for modern cat discovery, match tracking, adoption requests and shelter cat management.</p>
